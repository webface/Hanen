<?php global $wp_embed; ?>
<div class="fl-accordion fl-accordion-<?php echo $settings->label_size; if ( $settings->collapse ) echo ' fl-accordion-collapse'; ?>"  role="tablist"<?php if ( !$settings->collapse ) echo 'multiselectable="true"'; ?>>
