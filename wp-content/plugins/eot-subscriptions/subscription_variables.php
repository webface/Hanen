...
define('TABLE_QUIZ_QUESTION', $wpdb->prefix . 'eot_quiz_question');
define('TABLE_QUIZ_ANSWER', $wpdb->prefix . 'eot_quiz_answer');
define('TABLE_QUIZ_RESULT', $wpdb->prefix . 'eot_quiz_results');
define('TABLE_QUIZ_IN_COURSE', $wpdb->prefix . 'eot_quiz_in_course');
define('TABLE_QUIZ_ATTEMPT', $wpdb->prefix . 'eot_quiz_attempts');
define('TABLE_UPLOADS', $wpdb->prefix . 'user_uploads');
define('TABLE_COURSES',$wpdb->prefix.'eot_course');
...
define('TABLE_COURSES_MODULES',$wpdb->prefix.'eot_course_module');
...
define('TABLE_VIDEO_STATUS',$wpdb->prefix.'eot_video_status');
...
define('TABLE_TRACK',$wpdb->prefix.'eot_track');
