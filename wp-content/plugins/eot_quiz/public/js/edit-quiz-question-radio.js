(function ($) {
    ...
    // here we go!
    $.editQuizQuestionRadio = function (element, options) {
        ...
        var ajax_url = edit_quiz_question_radio.ajax_url;
        ...
        // element.data('editQuizQuestionRadio').settings.propertyName from outside the plugin, 
        ...
        plugin.answer = function (obj) {
            ...
            return '<div class="bs row answer" style="clear:both" id="answer_' + obj.ID + '">' +
                    '<div class="bs col-xs-2"><label class="bs radio-inline control-label"><input type="radio" name="correct_answer" value="' + obj.ID + '" ' + checked + '/>Correct?</label></div>' +
        ...
        // element.data('editQuizQuestionRadio').publicMethod(arg1, arg2, ... argn) from outside 
            ...
            if (valid) {
                ...
                $(element).find(".answer").each(function () {
                    var obj = {
                        ...
                        "answer_correct":($(this).find('input[type="radio"]').is(':checked'))?1:0
                    }
    ...
    $.fn.editQuizQuestionRadio = function (options) {

        // iterate through the DOM elements we are attaching the plugin to
        return this.each(function () {

            // if plugin has not already been attached to the element
            if (undefined == $(this).data('editQuizQuestionRadio')) {

                // create a new instance of the plugin
                // pass the DOM element and the user-provided options as arguments
                var plugin = new $.editQuizQuestionRadio(this, options);

                // in the jQuery version of the element
                // store a reference to the plugin object
                // you can later access the plugin and its methods and properties like
                // element.data('editQuizQuestionRadio').publicMethod(arg1, arg2, ... argn) or
                // element.data('editQuizQuestionRadio').settings.propertyName
                $(this).data('editQuizQuestionRadio', plugin);
