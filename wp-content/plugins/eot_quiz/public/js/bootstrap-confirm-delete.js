...
( function ( $, window, document, undefined )
{
    var bootstrap_confirm_delete = function ( element, options )
    {
        ...
        this.onDelete = function ( event )
        {
            ...
            {
                $( 'body' ).append( '<div id="bootstrap-confirm-delete-container"><div id="bootstrap-confirm-dialog" class="bs modal fade"><div class="bs modal-dialog modal-sm"><div class="bs modal-content"><div class="bs modal-header"><button type="button" class="bs close" data-dismiss="modal"><span aria-hidden="true">&times;</span><span class="sr-only">Close</span></button><h4 id="bootstrap-confirm-dialog-heading"></h4></div><div class="bs modal-body"><p id="bootstrap-confirm-dialog-text"></p></div><div class="bs modal-footer"><button id="bootstrap-confirm-dialog-cancel-delete-btn" type="button" class="bs btn btn-default pull-left" data-dismiss="modal">Cancel</button><a id="bootstrap-confirm-dialog-delete-btn" href="#" class="bs btn btn-danger pull-right">Delete</a></div></div></div></div></div>' );
            }
