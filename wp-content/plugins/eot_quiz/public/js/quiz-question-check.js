...
(function ($) {
    ...
    $.quizQuestionCheck = function (element, options) {
        ...
        // element.data('quizQuestionCheck').settings.propertyName from outside the plugin, 
        ...
        plugin.answer = function (id, text,num) {
            return '<div class="bs row" style="clear:both" id="' + id + '">' +
                    '<div class="bs col-xs-2"><label><input type="checkbox" name="correctquestion_' + id + '"/>&nbsp;Correct?</label></div>' +
        ...
        // element.data('quizQuestionCheck').publicMethod(arg1, arg2, ... argn) from outside 
    ...
    $.fn.quizQuestionCheck = function (options) {

        // iterate through the DOM elements we are attaching the plugin to
        return this.each(function () {

            // if plugin has not already been attached to the element
            if (undefined == $(this).data('quizQuestionCheck')) {

                // create a new instance of the plugin
                // pass the DOM element and the user-provided options as arguments
                var plugin = new $.quizQuestionCheck(this, options);

                // in the jQuery version of the element
                // store a reference to the plugin object
                // you can later access the plugin and its methods and properties like
                // element.data('quizQuestionCheck').publicMethod(arg1, arg2, ... argn) or
                // element.data('quizQuestionCheck').settings.propertyName
                $(this).data('quizQuestionCheck', plugin);
