...
(function ($) {
    ...
    $.quizQuestionText = function (element, options) {
        ...
        // element.data('quizQuestionText').settings.propertyName from outside the plugin, 
        ...
        plugin.answer = function (id, text,num) {
            return '<div class="bs row" style="clear:both" id="' + id + '">' +
                    '<div class="bs col-xs-12"><input class="bs form-control" type="text" name="' + id + '"  value="' + text + '"></div>' +
                    '</div>';
        };
        ...
        // element.data('quizQuestionText').publicMethod(arg1, arg2, ... argn) from outside 
    ...
    $.fn.quizQuestionText = function (options) {

        // iterate through the DOM elements we are attaching the plugin to
        return this.each(function () {

            // if plugin has not already been attached to the element
            if (undefined == $(this).data('quizQuestionText')) {

                // create a new instance of the plugin
                // pass the DOM element and the user-provided options as arguments
                var plugin = new $.quizQuestionText(this, options);

                // in the jQuery version of the element
                // store a reference to the plugin object
                // you can later access the plugin and its methods and properties like
                // element.data('quizQuestionText').publicMethod(arg1, arg2, ... argn) or
                // element.data('quizQuestionText').settings.propertyName
                $(this).data('quizQuestionText', plugin);
