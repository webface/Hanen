...
.fl-node-<?php echo $id; ?> .pp-heading-content .pp-heading .heading-title span.pp-primary-title {
...
.fl-node-<?php echo $id; ?> .pp-heading-content .pp-heading .heading-title span.pp-secondary-title {
...
<?php } else { ?>
.fl-node-<?php echo $id; ?> .pp-heading-content .pp-heading.pp-separator-inline .heading-title span.pp-primary-title {
    <?php if( $settings->font_title_line_space ) { ?>
    padding-left: <?php echo $settings->font_title_line_space; ?>px;
    <?php } ?>
}
.fl-node-<?php echo $id; ?> .pp-heading-content .pp-heading.pp-separator-inline .heading-title span.pp-secondary-title {
    <?php if( $settings->font_title_line_space ) { ?>
    padding-right: <?php echo $settings->font_title_line_space; ?>px;
    <?php } ?>
}
...
.fl-node-<?php echo $id; ?> .pp-heading-content .pp-heading.pp-separator-inline .heading-title <?php if ( $settings->dual_heading == 'no' ) { ?>span<?php } else { ?>span.pp-primary-title<?php } ?>:before {
...
.fl-node-<?php echo $id; ?> .pp-heading-content .pp-heading.pp-separator-inline .heading-title <?php if ( $settings->dual_heading == 'no' ) { ?>span<?php } else { ?>span.pp-secondary-title<?php } ?>:after {
    <?php if( $settings->line_width >= 0 ) { ?>
    width: <?php echo $settings->line_width; ?>px;
    <?php } ?>
    <?php if( $settings->heading_line_style ) { ?>
...
.fl-node-<?php echo $id; ?> .pp-heading-content .pp-sub-heading p:last-of-type {
    margin-bottom: 0;
}
