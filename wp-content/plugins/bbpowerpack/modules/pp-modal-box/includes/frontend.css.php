...
#modal-<?php echo $id; ?> .pp-modal .pp-modal-title {
    padding: 15px <?php echo $settings->title_padding; ?>px;
...
.fl-node-<?php echo $id; ?> .pp-modal-close:hover .bar-wrap,
#modal-<?php echo $id; ?> .pp-modal-close:hover .bar-wrap {
...
.fl-node-<?php echo $id; ?> .pp-modal.<?php echo $settings->animation_load; ?>.animated,
#modal-<?php echo $id; ?> .pp-modal.<?php echo $settings->animation_load; ?>.animated {
...
.fl-node-<?php echo $id; ?> .pp-modal.<?php echo $settings->animation_exit; ?>.animated,
#modal-<?php echo $id; ?> .pp-modal.<?php echo $settings->animation_exit; ?>.animated {
