...
if ( ! class_exists( 'Gamajo_Template_Loader' ) )  {
	...
	class Gamajo_Template_Loader {
		 ...
		 * @type string
		 */
		protected $plugin_directory = PW_SAMPLE_PLUGIN_DIR; // or plugin_dir_path( dirname( __FILE__ ) ); etc.
		 ...
		 * @type string
		 */
		protected $plugin_template_directory = 'parts'; // or includes/templates, etc.
