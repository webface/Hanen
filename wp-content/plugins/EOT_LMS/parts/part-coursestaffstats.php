...
<?php
                if ($enrollments) 
                {
                    ...
                    foreach ($enrollments as $enrollment) 
                    {
                        ...
                        $quizTableObj->rows[] = array(
                            $name,
                            "<a href='?part=staffquizstats&user_id=" . $enrollment['user_id'] . "&course_id=$course_id&subscription_id=$subscription_id'>" . $passed_count . '/' . count($quizzes_in_course) . "</a>",
                            "<a href='?part=staffquizstats&user_id=" . $enrollment['user_id'] . "&course_id=$course_id&subscription_id=$subscription_id'>" . $fail_count . "</a>",
                            "<a href='?part=loginrecordstats&user_id=" . $enrollment['user_id'] . "&course_id=$course_id&subscription_id=$subscription_id'>" . $login_count . "</a>",
                            "<a href='?part=videowatchstats&user_id=" . $enrollment['user_id'] . "&course_id=$course_id&subscription_id=$subscription_id'>" . $view_count . "</a>",
                            $status,
                            $percentage,
