...
?>              
            ...
            <div class="bs">
                ...
                <br>
                <br>
                <span class="bs"><a class="btn btn-success" href="/dashboard?part=manage_custom_modules&subscription_id=<?= $subscription_id; ?>">I'm done for now&nbsp;&nbsp;<i class="fa fa-exclamation"></i></a></span>
                <script>
