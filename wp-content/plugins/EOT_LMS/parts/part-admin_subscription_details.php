<div class="breadcrumb">
  <?= CRUMB_DASHBOARD ?>    
  <?= CRUMB_SEPARATOR ?>     
  <a href="?part=admin_view_subscriptions&library_id=<?= $_REQUEST['library_id'] ?>">View Subscriptions</a>    
  <?= CRUMB_SEPARATOR ?>  
  <span class="current">Subscription Details</span>   
</div>
			...
			<table class="data sm">
				<tbody>
					...
					<tr>
						<td></td>
						<td class="value">
							<a href="?part=update_subscription&subscription_id=<?= $subscription_id ?>&library_id=<?=$library_id?>">Update Subscription Details</a> - 
							<a id="delete_sub" href="<?= $admin_ajax_url ?>?action=getCourseForm&form_name=delete_subscription&amp;org_id=<?= $org_id ?>&subscription_id=<?=$subscription_id?>&library_id=<?=$library_id?>" rel="facebox">Delete Subscription</a><br>
						</td>
					</tr>
				</tbody>
			</table>
