...
*/
                                    ...
                                    {
                                        $('.round_msgbox').html("<?= __("ERROR: Some emails below did not get sent.", "EOT_LMS"); ?><br><br><?= __("Please contact us for assistance 1-877-239-3931 M-F 9-5 EST.", "EOT_LMS"); ?><br><br><?= __("Error message is: ", "EOT_LMS"); ?>" + result.message + "<br><br>" + sent_emails.replace(/,/g, "")); 
                                    }
                                    else
                                    {
                                        sendMail();
