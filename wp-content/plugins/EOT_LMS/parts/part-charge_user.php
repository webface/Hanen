<div class="breadcrumb">
  <?= CRUMB_DASHBOARD ?>    
  <?= CRUMB_SEPARATOR ?>    
    <span class="current">Charge a User</span>     
</div>
<?php
	if(isset($_REQUEST['subscription_id']) && $_REQUEST['subscription_id'] != "")
	{
		if(isset($_REQUEST['library_id']) && $_REQUEST['library_id'] != "")
		{
			...
			<h1 class="article_page_title">Charge a User</h1>
			<div id="bill_form">
				<form id="chargeUser">
...
<?php } ?>
			...
			<script>
				$('#submit_bill').click( function() {
	                ...
	                $('#chargeUser').show();
	                var data = $('#chargeUser').serialize () + "&action=chargeUser";
	                $.ajax({
	                    type: "POST",
	                    url: eot.ajax_url,
	                    data: data,
	                    ...
	                    success: function(response) {
	                        ...
	                        else
	                        {
	                            ...
	                            window.location.href = "?part=admin_view_subscriptions&library_id=" + response.library_id + "&status=chargeUser";
	                        }
