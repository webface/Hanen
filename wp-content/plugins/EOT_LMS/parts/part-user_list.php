...
//            $roles = str_replace('/bbp_participant', '', implode("/", $user->roles));
        ...
        foreach($directors as $director)
        {
            ...
            $email = $director->user_email; // User's Wordpress Email
