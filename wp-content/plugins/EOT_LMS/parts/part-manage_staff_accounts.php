  ...
  <div class="tablehead-tr">
    <div class="tablehead-tl">
      <div style="padding:7px;margin-left:5px;height:20px">
        <h3 style="float:left;" class="tablehead-title"> <?= lrn_upon_LE_Course_TITLE . " " . SUBSCRIPTION_YEAR ?> Staff Listing</h3><div style="clear:both;"></div>
      </div>  
    </div>
  </div>
</div>
...
<div class="bottom_buttons">
  <a class="btn" name="create_staff_account" style="" href="<?= $admin_ajax_url ?>?action=getCourseForm&form_name=create_staff_account&amp;org_id=<?= $org_id ?>&amp;portal_subdomain=<?= $org_subdomain ?>" rel="facebox">
