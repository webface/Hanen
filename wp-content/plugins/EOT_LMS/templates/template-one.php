 ...
 * This is based on the theme index.php template.
 */
        ...
        <div class="container">
            ...
            <div id="content" <?php if ( !is_single() && !is_page() && !is_attachment() ) echo 'class="hfeed"'; ?>>
                ...
                <section class="hentry">
                    ...
                    <h4>Content from the template-one.php page template</h4>

                    <h4><a href="http://wpsuperplugin.dev/template-one-page/">Template Page One</a></h4>
                    <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Proin ut elit at arcu vehicula bibendum. Fusce fringilla leo et rutrum convallis.</p>

                    <h4><a href="http://wpsuperplugin.dev/template-two-page/">Template Page Two</a></h4>
                    <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Proin ut elit at arcu vehicula bibendum. Fusce fringilla leo et rutrum convallis.</p>
