<?php
/**
 * @package Clean_Login_Custom
 * @version 1.8.1
 */
/*
Plugin Name: Clean Login Custom
Plugin URI: http://expertonlinetraining.com
Description: Original Clean Login. Modified for EOT Responsive Frontend Login and Registration plugin. A plugin for displaying login, register, editor and restore password forms through shortcodes. [clean-login] [clean-login-edit] [clean-login-register] [clean-login-restore]
Author: codection
Version: 1.8.1
