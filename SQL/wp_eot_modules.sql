...
--
-- Table structure for table `wp_eot_modules`
--
...
--
-- Dumping data for table `wp_eot_modules`
--

INSERT INTO `wp_eot_modules` (`id`, `title`, `description_text`, `created_at`, `updated_at`, `number_of_linked_courses`, `tags`, `library_id`, `category_id`, `component_type`, `video_id`, `org_id`, `creator_id`, `creator_first_name`, `creator_last_name`, `creator_email`) VALUES
...
--
-- Indexes for table `wp_eot_modules`
--
ALTER TABLE `wp_eot_modules`
  ADD PRIMARY KEY (`id`);
...
--
-- AUTO_INCREMENT for table `wp_eot_modules`
--
ALTER TABLE `wp_eot_modules`
